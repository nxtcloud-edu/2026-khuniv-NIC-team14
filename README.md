...
[💡 시작 배경](#-이런-문제에서-시작했어요) · [✨ 주요 기능](#-주요-기능) · [🖥 화면 구성](#-화면-구성) · [🛠 기술 스택](#-기술-스택) · [🚀 실행 방법](#-로컬에서-실행하기-ver01) · [📁 프로젝트 구조](#-프로젝트-구조) · [👥 팀 소개](#-팀-소개--team-mubig)
...
**뉴스레슨은 요약이 아니라 "선별"합니다.** 기사 전체를 압축하는 대신, 이해에 꼭 필요한 핵심 개념 1~3개만 골라 **정의 → 쉬운 설명 → 기사 속 맥락 → 경제적 영향** 순서로 짚어주고, 마지막엔 직접 자신의 말로 정리하게 합니다.
...
경제 도메인과 빅데이터 AI 기술의 융합으로 경제 지식을 자산화합니다.

| 이름 | 소속 | 역할 |
|---|---|---|
| 박연수 (팀장) | 무역학과 22 | 서비스 기획 & 프로젝트 총괄 |
| 김소륜 | 빅데이터응용학과 22 | UX/UI 설계 & 개발 |
| 김가현 | 빅데이터응용학과 23 | 서비스 기획 & 프롬프트 엔지니어링 |
| 김예원 | 빅데이터응용학과 23 | 프롬프트 엔지니어링 고도화 & UX/UI 설계 |
